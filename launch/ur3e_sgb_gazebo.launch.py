...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="ur_controllers_gazebo.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="ur3e_with_sg_b.urdf.xacro",
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare("thinc_lab_robots"), "urdf", description_file]),
            " ",
            "robot_ip:=",
            robot_ip,
            " ",
